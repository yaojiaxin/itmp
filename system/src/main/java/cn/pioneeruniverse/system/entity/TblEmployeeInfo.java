...
public class TblEmployeeInfo extends BaseEntity {
    ...
    private Long empId;
    private String empCode; // 用户代码
    private String sectionCode; // 用户归属处室代码
    private String depCode; // 用户归属部门代码
    private String orgCode; // 用户归属机构代码
    private Long empLevel; // 用户级别：1：普通员工 2：处长 3：部门领导 4：分管领导 5：总经理
    private String empEmail; // 用户邮箱
    private String empName; // 用户姓名
    private String empType; // 用户类型:1：内部员工  2：外部员工
    private String empPhone; // 用户手机
    private String empEmailnotice; // 当ITCD分配到这个人时，或状态发生变化时，是否邮件通知 0：不通知  1：通知
    private String empCertification; // 用户身份证号
    private String empInstitution; // 毕业院校
    private String empEdu; // 1：中专 2：大专 3：本科  4：研究生 5：博士生 0：其他
    private String empSupplier; // 所属供应商公司名称
    private String empState; // 1：有效 0：无效 2：异常
