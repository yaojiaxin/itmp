...
public interface IUserService extends IService<TblUserInfo> {
     ...
     * @Description 通过SVN账号获取svn用户详情
     * @MethodName getSvnUserDetailByUserAccount
     * @author yaojiaxin [yaojiaxin@pioneerservice.cn]
     * @Date 2019/1/4 14:46
     */
    TblUserInfoDTO getCodeBaseUserDetailByUserScmAccount(String userScmAccount);
     ...
     * @return
     */
    List<Map<String, Object>> selectById(String deptName, String companyName, String userName, Long userId, Long notWithUserID, Integer pageNumber, Integer pageSize);
    ...
    void updateMySvnPassword(String newPassword, HttpServletRequest request) throws NoSuchAlgorithmException, AccountException;
