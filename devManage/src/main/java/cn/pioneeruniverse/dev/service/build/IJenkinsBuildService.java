...
//	public boolean isJenkinsBuilding(TblToolInfo jenkinsTool, TblSystemJenkins tblSystemJenkins, String jobName) throws Exception;
	...
	String getStageViewDescribeJson(TblToolInfo jenkinsTool, TblSystemJenkins tblSystemJenkins, String jobName, int jobNumber) throws Exception;
	String getNextPendingInputAction(TblToolInfo jenkinsTool, TblSystemJenkins tblSystemJenkins, String jobName, int jobNumber) throws Exception;
	...
	String getStageViewDescribeExecutionJson(TblToolInfo jenkinsTool, TblSystemJenkins tblSystemJenkins, String jobName, int jobNumber, int describeId) throws Exception;
	String getStageViewExecutionLogJson(TblToolInfo jenkinsTool, TblSystemJenkins tblSystemJenkins, String jobName, int jobNumber, int executionId) throws Exception;
}
