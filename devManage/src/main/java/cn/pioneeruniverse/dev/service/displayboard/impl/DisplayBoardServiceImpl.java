...
public class DisplayBoardServiceImpl implements DisplayBoardService{
	...
	@Override
	public List<DevTaskVo> getDevTaskBySprintId(Long sprintId) {
		return requirementFeatureMapper.getDevTaskBySprintIds(sprintId);
	}
	...
	@Override
	public List<TblDevTask> getWorkTaskBySprintId(Long sprintId) {
		return devTaskMapper.getWorkTaskBySprintId(sprintId);
	}
