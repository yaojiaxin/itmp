	...
	var str = '<div class="onedatas canEdit">'+
		...
		'<div class="rowdiv">'+
			'<div class="form-group def_col_36">'+
				...
				'<div class="def_col_28"><input class="form-control sWorkSummary" placeholder="请输入" name="sWorkSummary" /></div>'+
		...
		'<div class="rowdiv">'+
			...
			'</div>'+
			'<div class="form-group def_col_12">'+
				'<label class="def_col_18  control-label fontWeihgt"><span class="redStar">*</span>预计工作量(人天)：</label>'+
				'<div class="def_col_18 "><input type="text" class="form-control sWorkPlanWorkload" placeholder="请输入" name="sWorkPlanWorkload" /></div> '+
			'</div>'+
		'</div>'+
		'<div class="rowdiv">'+
			'<div class="form-group def_col_12">'+
				'<label class="def_col_12 control-label fontWeihgt">任务分配：</label>'+
				'<div class="def_col_24 chanceMyself">'+
					'<input class="sWorkDivid" type="hidden" />'+
					'<input onclick="addDataEvents( this )" type="text" class="form-control pointStyle readonly def_col_20 sWorkDividUserName" name="" />'+
