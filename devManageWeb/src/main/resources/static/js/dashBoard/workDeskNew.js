            	...
            	for(var i=0;i<featureList.length;i++){
            		var span=getSpan(featureList[i].statusName);
      				str ='<div class="aTasks rowdiv">'+
      				   ...
      				   '<div class="def_col_9"><span title="'+delNull(featureList[i].systemName)+'">涉及系统：'+
      				   	  delNull(featureList[i].systemName)+'</span></div>'+
                       '<div class="def_col_7"><span title="'+delNull(featureList[i].windowName)+'">计划窗口：'+
            	...
            	for(var i=0;i<taskList.length;i++){
            		var span=getSpan(taskList[i].statusName);
      				str ='<div class="aTasks rowdiv">'+
      				   ...
      				   '<div class="def_col_9"><span title="'+delNull(taskList[i].systemName)+'">涉及系统：'+
            	...
            	for(var i=0;i<defectList.length;i++){
            		var span=getSpan(defectList[i].statusName);
      				str ='<div class="aTasks rowdiv">'+
      				   ...
      				   '<div class="def_col_9"><span title="'+delNull(defectList[i].systemName)+'">涉及系统：'+
      			...
      			for(var i=0;i<sjrList.length;i++){
                    ...
                    var environmentType;
      				...
      				str+='<div class="logDiv_title fontWeihgt"><span class="orderNum"></span>'+
    	                 '<span class="fontWeight">'+sjrList[i].systemName+"&nbsp;&nbsp;"+environmentType
