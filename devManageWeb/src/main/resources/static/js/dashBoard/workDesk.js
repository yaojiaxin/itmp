            ...
            success:function(data){
            	...
            	for(var j=0;j<taskList.length;j++){
      			...
      			for(var i=0;i<requirementList.length;i++){
      				if(requirementList[i].requirementStatus=="REQ_DEVELOP"){
      					inImplementation=inImplementation+1;
      				}else if(requirementList[i].requirementStatus=="REQ_DEVELOPCOM"){
      					implementationComplete=implementationComplete+1;
      				}else if(requirementList[i].requirementStatus=="REQ_END"){
      					onLine=onLine+1;
      				}else if(requirementList[i].requirementStatus=="REQ_PREPUBLISH"){
