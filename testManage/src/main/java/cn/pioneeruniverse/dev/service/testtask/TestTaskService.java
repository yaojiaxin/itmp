...
public interface TestTaskService {
	...
	void addTestTask(TblRequirementFeature requirementFeature, List<TblRequirementFeatureAttachement> files, HttpServletRequest request, String developmentDeptNumber);
	...
	void updateStatus(Long id,Integer testStage, HttpServletRequest request);
	...
	void synReqFeatureDeployStatus( Long requirementId,Long systemId, String deployStatus,
			String loginfo);
	...
	void synReqFeaturewindow(Long requirementId, Long systemId, Integer deptId, String loginfo, String deptBeforeName,
			String deptAfterName);

	void mergeTestTask(Long requirementId, Long systemId, HttpServletRequest request);
