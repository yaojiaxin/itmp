 ...
 * @return
 */
Map getTestTask(TblTestTask TblTestTask,String filters,Integer page,Integer rows,HttpServletRequest request);
/**
 * 获取测试任务(bootstrap)  
 * @param TblTestTask
 * @param page
...
//添加
void addtestTask(String obj,String attachFiles,Long Userid,HttpServletRequest request,String UserAccount);
...
String DevfindMaxCode(int length);
 ...
 /* 获取文件导出信息*/
List<TblTestTask> getExcelAllWork(TblTestTask tblDevTask,HttpServletRequest request);
Map ReqSystem();
Map ReqStatus();
/**
 * 获取弹窗用户信息
