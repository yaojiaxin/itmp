...
public class DefectExport {
    ...
    public static  String[] ArrayString(TblCustomFieldTemplate tblCustomFieldTemplate){
        ...
        titleValues[14] ="涉及系统";
        titleValues[15] ="所属需求";
        titleValues[16] ="关联工作任务";
        titleValues[17] ="关联测试任务";
        titleValues[18] ="工作任务编号";
        titleValues[19] ="测试任务编号";
        titleValues[20] ="驳回理由";
        titleValues[21] ="项目小组";
        titleValues[22] ="关闭时间";
        titleValues[23] ="模块";
        titleValues[24] ="发现版本号";
        titleValues[25] ="修复版本号";
        titleValues[26] ="期望修复时间";
        titleValues[27] ="估计工作量";
        titleValues[28] ="根本原因描述";
        titleValues[29] ="缺陷描述";
        return titleValues;
    }
