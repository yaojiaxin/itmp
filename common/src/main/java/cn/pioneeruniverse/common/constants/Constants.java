...
public class Constants {
    ...
    public static String ITMP_RETURN_SUCCESS = "1";

    public static String ITMP_RETURN_FAILURE = "2";

    public static Long ITMP_TOKEN_TIMEOUT = 30 * 60L;//秒


    public static String ITMP_TOKEN_HS_KEY = "ITMP_T";

    public static String ITMP_USER_PREFIX = "itmp_user_";

    public static String ITMP_DEPT_PREFIX = "DEPT_";

    public static String ITMP_COMPANY_PREFIX = "COMPANY_";

    public static String ITMP_DEVICE_PREFIX = "DVCI_";

    public static String ITMP_ROLE_PREFIX = "ROLE_";

    public static String ITMP_EMP_PREFIX = "EMP_";

    public static String ITMP_DEV_TASK_CODE = "DTSK-";//开发任务编号

    public static String ITMP_DEV_TASK_CODE_DATA = "DTSKD-";//同步开发任务编号

    public static String ITMP_WORK_TASK_CODE = "WTSK-";

    public static String ITMP_TESTWORK_TASK_CODE = "TWTSK-";

    public static String ITMP_TESTSET_SET_CODE = "TSST-";

    public static String ITMP_TEST_TASK_CODE = "TTSK-";//测试任务编号

    public static String TMP_TEST_DEFECT_CODE = "BUG-";// 缺陷编号

    public static String TMP_TEST_REQ_CODE = "REQ-";// 需求编号

    public static String TMP_CASE_INFO_NUMBER = "TC-";// 案例编号
