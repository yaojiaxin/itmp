...
function pageInit(){
    ...
    $("#list2").jqGrid({
        ...
        colModel:[ 
            ...
            {name:'操作',index:'操作',align:"center",fixed:true,sortable:false,resize:false,search: false,width:240,
...
//                    return '<a class="a_style" onclick="edit('+ row + ')">编辑</a> | <a class="a_style" onclick="end('+ row + ')">结束项目</a>'
                    ...
                    var d = '<a class="a_style" onclick="_versions('+row + ')">版本管理</a>';
                    opt_status.push(d);
...
//         url:"/system/role/getAllRole",
         url:"/projectManage/userPostPower/getUserPostByProject",
         method:"post",
         data:{
            'projectId':id,
         },
